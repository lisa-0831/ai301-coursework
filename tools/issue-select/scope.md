...
I’m comfortable with Go, Python, JavaScript/Node.js, SQL, Docker, Git/GitHub, and AWS. I’d like to get better at navigating unfamiliar open-source codebases and making backend or tooling contributions. For a first issue, I prefer something with a clear, manageable scope and reproducible behavior rather than a large architectural change.
